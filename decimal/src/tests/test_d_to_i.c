...
Suite *suite_dtoi(void) {
  Suite *s = suite_create("decimal_to_int");
  TCase *tc = tcase_create("insert_tc");

  // tcase_add_test(tc, dec_t_int_1);
  // tcase_add_test(tc, dec_t_int_2);
  // tcase_add_test(tc, dec_t_int_3);
  // tcase_add_test(tc, dec_t_int_4);
  // tcase_add_test(tc, dec_t_int_5);
  // tcase_add_test(tc, dec_t_int_6);
  // tcase_add_test(tc, dec_t_int_7);
  tcase_add_test(tc, dec_t_int_10);
  tcase_add_test(tc, dec_t_int_11);
  tcase_add_test(tc, dec_t_int_12);
  tcase_add_test(tc, dec_t_int_13);
  tcase_add_test(tc, dec_t_int_14);
  // tcase_add_test(tc, dec_t_int_15);
  tcase_add_test(tc, dec_t_int_16);
  tcase_add_test(tc, dec_t_int_17);
  tcase_add_test(tc, dec_t_int_18);
  tcase_add_test(tc, dec_t_int_19);
  tcase_add_test(tc, dec_t_int_20);
  tcase_add_test(tc, dec_t_int_21);
  tcase_add_test(tc, dec_t_int_22);
  tcase_add_test(tc, dec_t_int_23);
  tcase_add_test(tc, dec_t_int_24);
  tcase_add_test(tc, dec_t_int_25);
  tcase_add_test(tc, dec_t_int_26);
  tcase_add_test(tc, dec_t_int_27);
  tcase_add_test(tc, dec_t_int_28);
  tcase_add_test(tc, dec_t_int_29);
  tcase_add_test(tc, dec_t_int_30);
  // tcase_add_test(tc, dec_t_int_31);
  tcase_add_test(tc, dec_t_int_32);
  tcase_add_test(tc, dec_t_int_33);
  tcase_add_test(tc, dec_t_int_34);
  tcase_add_test(tc, dec_t_int_35);
  tcase_add_test(tc, dec_t_int_36);
  tcase_add_test(tc, dec_t_int_37);
